<template>
  <div>
    ...
    <div class="bz-kpi-rail">
      <BzKpiTile label="Jami" :value="stats.total" icon="mdi-sale" color="#F59E0B" bg="rgba(245,158,11,0.10)" :loading="statsLoading" />
      ...
      <BzKpiTile label="Mahsulotlarda" :value="stats.withProducts" icon="mdi-cube-outline" color="#06B6D4" bg="rgba(6,182,212,0.10)" :loading="statsLoading" />
      <BzKpiTile label="Kategoriyalarda" :value="stats.withCategories" icon="mdi-tag-multiple-outline" color="#A855F7" bg="rgba(168,85,247,0.10)" :loading="statsLoading" />
    </div>
